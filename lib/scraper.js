...
const ANNAS_ARCHIVE_BASE = process.env.ANNAS_ARCHIVE_BASE || 'https://annas-archive.org';
const ZLIB_BASE = process.env.ZLIB_BASE || '1lib.sk';
...
async function getPopularBooks(langCode, page = 1) {
  const domain = `${langCode}.${ZLIB_BASE}`;
